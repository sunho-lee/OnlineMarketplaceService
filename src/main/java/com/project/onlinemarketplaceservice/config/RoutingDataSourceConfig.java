...
import com.project.onlinemarketplaceservice.enumeration.DatabaseType;
...
public class RoutingDataSourceConfig {
    ...
    /**
     * AbstractRoutingDataSource : 조회 키를 기반으로 대상 DataSource 중 하나를 getConnection()로 호출하여 라우팅합니다.
     * AbstractRoutingDataSource는 targetDataSources라는 Map 오브젝트를 가지고 있는데 여기에는 조회 키-DataSource 쌍들이 담겨져
     * 있습니다. determineCurrentLookupKey()를 호출하여 조회 키를 리턴받고, 해당 키로 targetDataSource에 저장된 DataSource 중
